...
> **ADVISORY ONLY. Nothing here is an owner ruling.** The owner's verbatim prompt: *"I would rather just position it for personal use. It would be hard to sell to investment banks. That is my utmost priority and help me decide best way to do so. I like your timeline, but have tech council or just you decide on best timeline for this."* Owner rulings, when given, are recorded in HANDOFF §3. Per the standing lesson (HANDOFF §3 2026-09-07, memory `council-draft-is-not-owner-ruling`), none of the "Default: yes" items below is ratified until the owner types it.
