...
**Status: Step 1a DONE 2026-09-10 (data layer built and red-teamed; see HANDOFF §3). Step 1b next. Gate G2 was ruled "proceed under the
...
| owner time | one ~3-page G3 read + the 22 rulings above; one per-fold read at Step 4 |
